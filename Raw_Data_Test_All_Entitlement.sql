CREATE OR REPLACE TABLE `nbcu-ds-sandbox-a-001.Shunchao_Sandbox.VOD_AD_LOAD_Data_Raw_Test_0501_0512` as
...
where adobe_date between "2023-05-01" and "2023-05-12" and adobe_tracking_id is not null and lower(consumption_type_detail) = "vod"),
...
where report_date between "2023-05-01" and "2023-05-12" 
...
from SV
left join SU on SV.adobe_date = SU.report_date and SV.adobe_tracking_id = SU.adobe_tracking_id
